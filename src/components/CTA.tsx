          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {[
              ...
              <motion.span
                ...
                className="px-5 py-2.5 text-sm font-mono text-white border border-accent/30 rounded-full bg-accent/10 hover:bg-accent/15 transition-colors cursor-default"
              >
                {phrase}
              </motion.span>
            ))}
